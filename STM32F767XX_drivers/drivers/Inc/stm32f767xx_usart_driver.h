...
/* Configurable items for USART USer Application */
...
#define SUART_STD_BAUD_6M 					6000000
 ...
 * USART Flags
 */
#define USART_TXE_FLAG							(1 << USARTx_ISR_TXE)
#define USART_RXNE_FLAG							(1 << USARTx_ISR_RXNE)
#define USART_TC_FLAG							(1 << USARTx_ISR_TC)
